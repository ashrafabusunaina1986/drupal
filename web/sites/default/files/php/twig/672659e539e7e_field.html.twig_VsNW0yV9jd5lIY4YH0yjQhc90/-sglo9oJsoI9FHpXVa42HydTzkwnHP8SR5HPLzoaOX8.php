...
class __TwigTemplate_10dd1b17ba6a54909ad10d28e446137b extends Template
{
...
";
        ...
        if (($context["label_hidden"] ?? null)) {
            ...
            if (($context["multiple"] ?? null)) {
                // line 57
                yield "    <div";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [($context["classes"] ?? null), "field-items"], "method", false, false, true, 57), 57, $this->source), "html", null, true);
                yield ">
      ";
                // line 58
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 64
                    yield "      <div";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [($context["classes"] ?? null), "field-item"], "method", false, false, true, 64), 64, $this->source), "html", null, true);
                    yield ">";
    ...
    ";
            ...
            if (($context["multiple"] ?? null)) {
                // line 71
                yield "      <div class=\"field__items field-items\">
    ";
            }
            // line 73
            yield "    ";
...
";
    ...
    {
        return new Source("", "themes/contrib/tara/templates/field/field.html.twig", "C:\\Users\\AL-YAMEN\\Desktop\\drupal\\web\\themes\\contrib\\tara\\templates\\field\\field.html.twig");
    }
